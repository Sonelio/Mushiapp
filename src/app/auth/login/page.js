...
export default function LoginPage() {
  ...
  return (
    <div className={`min-h-screen w-screen flex items-center justify-center relative overflow-hidden ${poppins.className}`}>
      <Image
      ...
      />
      <div className="p-8 rounded-[30px] w-[85%] md:w-full max-w-[450px] relative z-10 mx-4 md:mx-0 mt-20 md:mt-0 flex flex-col" style={{ backgroundColor: "#20382E" }}>
        {/* App Logo */}
